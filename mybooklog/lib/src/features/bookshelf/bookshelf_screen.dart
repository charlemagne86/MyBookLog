...
///   * use the always-visible search bar and read/unread + category chips
///     to narrow the shelf,
...
class _BookshelfScreenState extends State<BookshelfScreen> with RouteAware {
  ...
  bool _loading = true;
  // What's typed into the persistent search bar.
  String _searchQuery = '';
        ...
        child: Column(
          children: [
            ...
            BookshelfSearchBar(
              ...
              onFilterChanged: (filter) => setState(() => _readFilter = filter),
